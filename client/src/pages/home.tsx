...
const FINANCE_NEWS = [
  {
    ...
    summary:
      "Investors are staying cautious as rate-cut expectations keep shifting across global markets.",
  },
  {
    kicker: "Crypto",
    title: "Bitcoin holds key support while altcoins trade in a narrow range",
    summary:
      "Momentum is cooling, but traders still expect a breakout if volume returns later this week.",
  },
  {
    kicker: "Forex",
    title: "Dollar steadies after central bank comments calm volatility",
    summary:
      "Currency desks are watching policy signals closely as risk appetite improves slightly.",
  },
  {
    kicker: "Commodities",
    title: "Gold edges higher as investors look for safer positioning",
    summary:
      "A softer risk tone and uncertain macro signals are pushing defensive assets back in focus.",
  },
];
...
export default function Home() {
  ...
  const [actionType, setActionType] = useState<"buy" | "sell" | "send" | null>(
    null,
  );

  const holdingIds = useMemo(
    () => holdings.map((holding) => holding.coinId),
    [holdings],
  );
  ...
  useEffect(() => {
    const loadCoins = async () => {
      try {
        ...
        const holdingCoins = missingHoldingIds.length
          ? await getCoinsByIds(missingHoldingIds, "usd")
          : [];
          ...
          <div className="max-w-md md:max-w-2xl lg:max-w-4xl xl:max-w-5xl mx-auto p-4 flex items-center justify-between">
              ...
              <SheetTrigger asChild>
                <button className="text-left outline-none cursor-pointer">
                  ...
                  <span className="text-white font-bold">
                    {userData?.username || "vaultycreator"}
                  </span>
                </button>
              </SheetTrigger>
              <SheetContent
                side="left"
                className="w-[300px] bg-black border-r border-white/10 p-0 text-white"
              >
                  ...
                  <div className="p-6 space-y-4 text-center flex flex-col items-center shrink-0 border-b border-white/5">
                    ...
                    <div className="space-y-1">
                      <h2 className="font-bold text-xl">
                        {userData?.displayName || "Vaulty Support"}
                      </h2>
            ...
            <div className="flex items-center gap-3">
              <Link href="/notifications">
                <button
                  className="relative w-10 h-10 flex items-center justify-center rounded-full bg-white/[0.03] hover:bg-white/[0.08] transition-all border border-white/[0.05] group text-white/60 group-hover:text-white"
                  data-testid="button-home-notifications"
                >
              ...
              <Link href="/wallet">
                <button
                  className="w-10 h-10 flex items-center justify-center rounded-full bg-white/[0.03] hover:bg-white/[0.08] transition-all border border-white/[0.05] text-white/60 hover:text-white"
                  data-testid="button-home-wallet"
                >
      ...
      >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-8">
          ...
          <div className="flex flex-col space-y-4">
            ...
            <div className="relative overflow-hidden rounded-[32px] border border-white/[0.08] bg-gradient-to-b from-white/[0.05] to-transparent p-7 shadow-[0_8px_32px_rgba(0,0,0,0.4)] backdrop-blur-2xl h-[420px] flex flex-col">
                    ...
                    <div className="relative z-10 flex gap-4">
                      ...
                      <div className="flex-1">
                        ...
                        <p className="text-[12px] text-white/60 leading-relaxed mb-3">
                          Today's lesson: "How to land your first $500 freelance
                          client on Upwork."
                        </p>

                        <div className="flex items-center justify-between">
                          <div className="flex -space-x-2">
                            <div className="w-6 h-6 rounded-full bg-white/10 border-2 border-black flex items-center justify-center text-[10px] font-bold text-white z-20">
                              1
                            </div>
                            <div className="w-6 h-6 rounded-full bg-white border-2 border-black flex items-center justify-center text-[10px] font-bold text-white z-10">
                              <Check size={10} />
                            </div>
                            <div className="w-6 h-6 rounded-full bg-white/5 border-2 border-black flex items-center justify-center text-[10px] font-bold text-white/30 z-0">
                              3
                            </div>
                          </div>
                          <button className="text-[11px] font-bold text-black bg-white hover:bg-gray-300 px-4 py-1.5 rounded-full transition-colors">
                            Start Lesson
                          </button>
                        </div>
                      </div>
                    ...
                    <div className="relative z-10 flex gap-4 items-center">
                      ...
                      <div className="flex-1">
                        <h3 className="text-base font-bold text-white tracking-tight mb-1">
                          Trading Proving Ground
                        </h3>
                        <p className="text-[12px] text-white/60 leading-relaxed">
                          Master risk management risk-free.
                        </p>
          ...
          <div className="w-full xl:col-span-1 shrink-0 space-y-8">
            ...
            >
              ...
              <div className="relative z-10 text-center">
                ...
                <p
                  className="text-[1.1rem] leading-relaxed font-medium text-white italic"
                  data-testid="text-home-daily-motivation"
                >
                  "{dailyMotivation}"
                </p>
              </div>
                ...
                <AnimatePresence mode="wait">
                  ...
                  >
                    <div className="flex-1 min-w-0 text-left pl-0">
                      ...
                      <h3 className="text-[1.8rem] leading-[1.1] font-black text-white mb-2.5 tracking-tight group-hover:text-transparent group-hover:bg-clip-text group-hover:bg-gradient-to-r group-hover:from-white group-hover:to-gray-300 transition-all">
                ...
                <div className="relative z-10 flex items-start justify-between gap-5">
                  <div className="flex-1">
                    ...
                    <p className="mt-3 max-w-[260px] text-sm leading-relaxed text-slate-300">
                      Get instant market explanations, plan ideas, and simple
                      breakdowns in one polished chat space.
                    </p>
