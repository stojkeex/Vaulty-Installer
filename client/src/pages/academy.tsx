...
const courses = [
  ...
  },
  {
    ...
    category: "Basics",
    duration: "5 min",
    accent: "from-purple-500/30 via-slate-800/35 to-black/90",
  },
  {
    ...
    category: "Crypto",
    duration: "10 min",
    accent: "from-[#00CCFF]/25 via-slate-800/35 to-[#FF00BB]/25",
  },
  {
    slug: "tempel-bonds",
    ...
    category: "Strategy",
    duration: "7 min",
    accent: "from-[#00CCFF]/25 via-slate-900/40 to-[#FF00BB]/25",
  },
  {
    ...
    category: "Mindset",
    duration: "4 min",
    accent: "from-[#FF00BB]/20 via-slate-900/40 to-[#00CCFF]/20",
  },
  {
    slug: "payiety-sbages",
    ...
    category: "Planning",
    duration: "9 min",
    accent: "from-[#00CCFF]/20 via-slate-900/40 to-[#FF00BB]/20",
  },
  {
...
export default function Academy() {
  ...
  return (
    <div className="relative min-h-screen overflow-hidden bg-black pb-28 text-white">
      ...
      <div className="sticky top-0 z-20 border-b border-vaulty-gradient bg-black/60 backdrop-blur-2xl">
        <div className="mx-auto flex max-w-md items-center justify-between px-4 py-4">
          <button
            onClick={() => setLocation("/")}
            className="flex h-11 w-11 items-center justify-center rounded-full border-vaulty-gradient bg-white/5 text-white transition-colors hover:bg-white/10"
          ...
          <div className="flex h-11 w-11 items-center justify-center rounded-full border-vaulty-gradient bg-white/5 text-gray-300">
            <BookOpen size={18} />
          </div>
        </div>
      </div>
      ...
      <div className="relative z-10 mx-auto flex max-w-md flex-col gap-6 px-4 pb-8 pt-5">
        <div className="overflow-hidden rounded-[32px] border-vaulty-gradient bg-white/[0.06] p-5 shadow-[0_20px_60px_rgba(0,204,255,0.15)] backdrop-blur-2xl">
          ...
          <div className="relative space-y-5">
            <div className="inline-flex items-center gap-2 rounded-full border-vaulty-gradient bg-white/5 px-3 py-1.5 text-[11px] font-black uppercase tracking-[0.24em] text-gray-300">
            ...
            <div className="grid grid-cols-3 gap-2.5">
              {quickStats.map((stat) => (
                <div
                  key={stat.label}
                  className="rounded-2xl border-vaulty-gradient bg-black/25 px-3 py-3 text-left"
        ...
        <div className="relative">
          ...
          <input
            ...
            className="w-full rounded-[24px] border-vaulty-gradient bg-white/[0.06] py-4 pl-11 pr-4 text-white shadow-[inset_0_1px_0_rgba(255,255,255,0.05)] backdrop-blur-xl outline-none transition-all placeholder:text-gray-500 focus:border-vaulty-gradient focus:bg-white/[0.08]"
        ...
        <Link href={`/academy/${featuredCourse.slug}`}>
          <div
            className="group relative overflow-hidden rounded-[30px] border-vaulty-gradient bg-gradient-to-br from-slate-700/35 via-slate-900/30 to-black p-5 shadow-[0_18px_50px_rgba(0,204,255,0.15)] backdrop-blur-2xl hover:shadow-[0_20px_60px_rgba(255,0,187,0.2)] transition-shadow duration-500"
          ...
          >
            ...
            <div className="relative flex items-start justify-between gap-4">
              <div className="space-y-3">
                <div className="inline-flex items-center gap-2 rounded-full border-vaulty-gradient bg-white/5 px-3 py-1 text-[10px] font-black uppercase tracking-[0.2em] text-gray-300">
                  <TrendingUp size={12} />
                  Featured topic
                </div>
                <div>
              ...
              <div className="flex h-12 w-12 shrink-0 items-center justify-center rounded-full border-vaulty-gradient bg-white/10 transition-colors group-hover:bg-white/15">
        ...
        <div className="flex items-end justify-between px-1">
          ...
          <span className="rounded-full border-vaulty-gradient bg-white/5 px-3 py-1.5 text-xs font-bold text-gray-300" data-testid="text-search-results">
        ...
        <div className="grid grid-cols-2 gap-4">
          {filteredCourses.map((course) => (
            <Link key={course.slug} href={`/academy/${course.slug}`}>
              <div
                className={`group relative flex min-h-[190px] cursor-pointer flex-col justify-between overflow-hidden rounded-[28px] border-vaulty-gradient bg-gradient-to-br ${course.accent} p-4 shadow-[0_16px_40px_rgba(0,204,255,0.15)] hover:shadow-[0_20px_50px_rgba(255,0,187,0.2)] transition-all duration-300 hover:-translate-y-0.5`}
              ...
              >
                ...
                <div className="relative z-10 flex items-start justify-between gap-2">
                  <span className="rounded-full border-vaulty-gradient bg-black/20 px-2.5 py-1 text-[10px] font-black uppercase tracking-[0.18em] text-gray-200">
                    {course.category}
                  </span>
                  <span className="flex h-10 w-10 items-center justify-center rounded-full border-vaulty-gradient bg-white/10 text-white transition-colors group-hover:bg-white/15">
