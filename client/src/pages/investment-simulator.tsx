    ...
    <div className="min-h-screen bg-black text-white pb-24">
      <div className="sticky top-0 z-50 bg-black/80 backdrop-blur-xl border-b border-white/10 px-4 py-4">
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-xs text-indigo-400 font-medium">Compound Interest Magic</p>
          </div>
        </div>
      </div>
      ...
      <div className="p-5 space-y-6">
        ...
        <div className="text-center py-6">
          <p className="text-sm font-medium text-gray-400 uppercase tracking-widest mb-2">Projected Wealth</p>
        ...
        <div className="bg-white/5 border border-white/10 rounded-[32px] p-6 space-y-6">
          ...
          <div className="space-y-4">
            ...
            <div>
              <div className="flex justify-between mb-2">
                <label className="text-sm font-medium text-gray-300">Expected Annual Return</label>
