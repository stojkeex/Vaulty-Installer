...
import LOGO from "@/assets/IMG_1036_1775418773775.png";
          ...
          <>
            ...
            {post.type === 'video' && (
                <div className="w-full h-1 bg-white/10 rounded-full mt-2 overflow-hidden shadow-inner">
                    <div 
                        className="h-full bg-gradient-to-r from-slate-500 via-red-500 to-yellow-500 transition-all duration-100 ease-linear shadow-[0_0_10px_rgba(236,72,153,0.5)]"
