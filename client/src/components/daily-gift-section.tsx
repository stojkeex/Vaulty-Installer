  ...
  return (
    <div className="glass-card rounded-3xl p-6 space-y-6">
      <div className="flex items-center justify-between">
        ...
        <div className="p-2 rounded-xl bg-gradient-to-br from-slate-500/20 to-purple-500 border border-gray-500/30">
          ...
          return (
            <div
              ...
              className={cn(
                ...
                isClaimed
                  ? "bg-gradient-to-b from-blue-500/20 to-purple-500 border border-gray-500/30"
                  : isCurrentDay
                    ? "bg-gradient-to-b from-blue-500 to-purple-500 border border-white/30 shadow-[0_0_15px_rgba(6,182,212,0.3)] scale-110 z-10"
