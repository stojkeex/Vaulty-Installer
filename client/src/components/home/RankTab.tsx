...
export function RankTab() {
  ...
  return (
    <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
      ...
      {/* Current Rank Card */}
      <div className="relative overflow-hidden rounded-3xl border-vaulty-gradient bg-gradient-to-br from-blue-500 to-black p-8 text-center shadow-[0_8px_32px_rgba(0,204,255,0.2)]">
        {/* Ambient Glow */}
        <div 
          className={cn(
