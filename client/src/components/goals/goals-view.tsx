    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between gap-4">
        ...
        <button
          ...
          className="flex h-12 w-12 shrink-0 items-center justify-center rounded-2xl border border-sky-400/20 bg-gradient-to-br from-blue-500 to-blue-500 text-slate-950 shadow-[0_16px_36px_rgba(59,130,246,0.3)] transition-transform hover:scale-[1.03] active:scale-[0.97]"
