      ...
      {isOpen && (
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-black/80 backdrop-blur-md">
          ...
          >
            ...
            <div className="absolute top-0 inset-x-0 h-1 bg-gradient-to-r bg-white/10" />
            ...
            <div className="p-8 pt-10 text-center">
                ...
                {plans.map((plan) => (
                  ...
                  >
                    ...
                    <div className="space-y-1">
                      ...
                      <p className="text-4xl font-black bg-gradient-to-br from-blue-500 via-white to-purple-500 bg-clip-text text-transparent">${plan.promo}</p>
              ...
              <div className="mt-6 flex flex-col items-center gap-4">
                <Button 
                  className="w-full h-14 bg-gradient-to-r bg-white/10 hover:opacity-90 text-white font-black text-lg rounded-2xl shadow-xl shadow-gray-400/20 border-none"
                  onClick={() => setIsOpen(false)}
                >
                  GET OFFER NOW
                </Button>
