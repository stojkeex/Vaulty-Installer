  ...
  return (
    <div className="perspective-1000 mb-6">
      ...
      >
        ...
        >
          <div className="absolute inset-0 bg-gradient-to-br from-blue-500/5 via-transparent to-purple-500 opacity-0 hover:opacity-100 transition-opacity duration-500 pointer-events-none" />
          ...
          <div className="p-5 relative z-10">
            ...
            <div className="flex justify-between items-start mb-4">
              <div className="flex gap-3 items-center">
                ...
                >
                  <div className="absolute inset-0 bg-gradient-to-tr from-blue-500 to-purple-500 rounded-full opacity-70 blur-sm hover:opacity-100 transition-opacity" />
                  <img 
                ...
                <DialogContent onClick={(e) => e.stopPropagation()} className="bg-zinc-950 border-vaulty-gradient text-white sm:max-w-md">
                  ...
                  <DialogFooter className="flex-col gap-3 sm:flex-col items-center">
                     ...
                     <Button 
                       ...
                       disabled={isTipping}
                       className="w-full bg-gradient-to-r from-blue-500 to-purple-500 hover:from-blue-500 hover:to-purple-500 text-black font-bold"
                     >
        ...
        >
          ...
          <div className="flex flex-col items-center justify-center w-full h-full space-y-2 py-2">
            <h2 className="text-lg sm:text-2xl font-bold text-white bg-gradient-to-r from-blue-500 to-purple-500 bg-clip-text text-transparent line-clamp-1">
              Share This Post
            </h2>
            ...
            <div className="bg-white p-3 sm:p-5 rounded-2xl sm:rounded-[2rem] shadow-2xl relative group shrink min-h-0">
              <div className="absolute inset-0 bg-gradient-to-tr from-blue-500/20 to-purple-500 rounded-2xl sm:rounded-[2rem] blur-xl opacity-0 group-hover:opacity-100 transition-opacity" />
